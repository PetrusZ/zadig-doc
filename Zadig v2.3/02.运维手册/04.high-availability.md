...
permalink: /Zadig v2.3/stable/high-availability/
---
...
```
3. 导入警报规则，导入方法可参考granfa文档，https://grafana.com/docs/grafana/latest/alerting/set-up/provision-alerting-resources/file-provisioning/#import-alert-rules
```yaml
apiVersion: 1
groups:
    - orgId: 1
      ...
      rules:
        ...
        - uid: RCovy7PIk
          ...
          isPaused: false
```
4. 在面板列表中找到 Zadig 监控面板, 确认数据正常展示。

## FAQs

参考文档：[部署运维 FAQs](/Zadig%20v2.3/faq/debug-system/)。
